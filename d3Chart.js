...
d3Chart._drawPoints = function(el, scales, data, range) {
    ...
    console.log('zzzzzzzzzzzzzzzzzzzzzzzzzzzzz xx', xx)
    console.log('zzzzzzzzzzzzzzzzzzzzzzzzzzzzz yy', yy)
    ...
    point.attr('transform', function(d){
            ...
            // console.log( 'ccccccccccccccccccccc--1 :', d.y[0].value, dataY)
        ...
        .attr( 'height', function(d){
            ...
            // console.log( 'ccccccccccccccccccccc--2 :', d.y[0].value, o)
            return o
        })
